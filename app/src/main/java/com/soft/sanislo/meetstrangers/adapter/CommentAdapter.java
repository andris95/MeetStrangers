 ...
 */
public class CommentAdapter extends FirebaseRecyclerAdapter<CommentModel, CommentViewHolder> {
    ...
    public CommentAdapter(Class<CommentModel> modelClass, int modelLayout, Class<CommentViewHolder> viewHolderClass, Query ref) {
        super(modelClass, modelLayout, viewHolderClass, ref);
    }

    public CommentAdapter(Class<CommentModel> modelClass, int modelLayout, Class<CommentViewHolder> viewHolderClass, DatabaseReference ref) {
        super(modelClass, modelLayout, viewHolderClass, ref);
    }
    ...
    public interface OnClickListener {
        void onClick(View view, int position, CommentModel commentModel);
