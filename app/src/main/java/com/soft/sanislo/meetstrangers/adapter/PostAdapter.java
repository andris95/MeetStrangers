 ...
 */
public class PostAdapter extends FirebaseRecyclerAdapter<Post, UserPostViewHolder> {
    ...
    public PostAdapter(Context context, Class<Post> modelClass, int modelLayout,
                       Class<UserPostViewHolder> viewHolderClass, DatabaseReference ref) {
        super(modelClass, modelLayout, viewHolderClass, ref);
        mContext = context;
    }

    public PostAdapter(Context context, Class<Post> modelClass, int modelLayout,
                       Class<UserPostViewHolder> viewHolderClass, Query ref) {
        super(modelClass, modelLayout, viewHolderClass, ref);
        mContext = context;
    }

    @Override
    protected void populateViewHolder(UserPostViewHolder viewHolder, Post model, int position) {
